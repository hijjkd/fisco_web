    ...
    <div>
        ...
        <div class="block-wrapper">
            <el-table :data="transactionList" class="block-table-content" :row-key="getRowKeys" :expand-row-keys="expands">
                ...
                <el-table-column prop="hash" label="TransactionHash" align="center" :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="blockNumber" label="BlockHeight" :show-overflow-tooltip="true" align="center" width="100"></el-table-column>
            </el-table>
        </div>
    </div>
</template>
